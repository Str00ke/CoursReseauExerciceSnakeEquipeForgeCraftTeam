		...
		while (window.pollEvent(event))
		{
			switch (event.type)
			{
				...
				case sf::Event::KeyPressed:
				{
					...
					{
						case sf::Keyboard::Up:
              Message::SendMessageToServer(sock, Opcodes::Input, InputMessageStruct(0));
							direction = sf::Vector2i(0, -1);
							break;

						case sf::Keyboard::Down:
              Message::SendMessageToServer(sock, Opcodes::Input, InputMessageStruct(1));
							direction = sf::Vector2i(0, 1);
							break;

						case sf::Keyboard::Left:
              Message::SendMessageToServer(sock, Opcodes::Input, InputMessageStruct(2));
							direction = sf::Vector2i(-1, 0);
							break;

						case sf::Keyboard::Right:
              Message::SendMessageToServer(sock, Opcodes::Input, InputMessageStruct(3));
							direction = sf::Vector2i(1, 0);
							break;
